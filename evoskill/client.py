...
from .memory import MEMORY_KIND_EXPERIENCE, normalize_memory_kind
...
class EvoSkill:
    ...
    def __init__(
        ...
        *,
        ...
        self.config = config or EvoSkillConfig()
    ...
    @classmethod
    def from_config(cls, config: Dict[str, Any]) -> "EvoSkill":
        """Constructs `EvoSkill` from a plain dict config."""

        return cls(EvoSkillConfig.from_dict(config))
    ...
    def ingest(
        ...
        *,
        ...
        skip_merge_ids: Optional[set] = None,
    ) -> List[Skill]:
        """
        ...
        max_candidates = max(0, int(self.config.max_candidates_per_ingest))
        ...
        return self.maintainer.apply(extracted, user_id=user_id, metadata=metadata, skip_ids=skip_merge_ids)
    ...
    def extract_candidates(
        ...
        *,
        ...
        limit = (
            ...
            else max(0, int(self.config.max_candidates_per_ingest))
        )
    ...
    def search(
        ...
        *,
        ...
        meta_filters = dict(merged.get("metadata") or {})
        normalized_kind = normalize_memory_kind(memory_kind or meta_filters.get("memory_kind"))
        meta_filters["memory_kind"] = normalized_kind
        merged["metadata"] = meta_filters
    ...
    def search_experiences(
        ...
        *,
        ...
        """Retrieves failure experiences / guardrails relevant to a query."""
